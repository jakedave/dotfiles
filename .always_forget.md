...
kubectl create deployment <name> --image=<image> [options]                                     = create a deployment with <name> based on <image> (e.g. nginx, mongo, etc.)
...
1helm get manifest full-coral1                                                                   = print all k8s resources associated with release 'full-coral'
